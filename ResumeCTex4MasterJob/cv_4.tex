...
编程技能：熟悉C++(with STL)及其编程思想；熟悉Cocos2d-x，了解组件式编程、Unity 3D引擎及其UI系统\\%了解C\#，JavaScript，Python及PHP\\
学科背景：具有图形学、计算机几何基础及现代OpenGL编程能力；对基础算法与数据结构、操作系统及计算机网络基础等有较深入的理解和掌握；熟悉面向对象设计及常用设计模式
\end{rSection}
%----------------------------------------------------------------------------------------
...
\item 运维与设备云系统是针对各城市物业开发的配电室管理系统和信息管理中心。本人的工作是负责后端MC层模块开发。为此，优化了Mysql数据库的设计，定制了数据传输及路由规范，并使用了多种设计模式完成了一个低耦合、高复用、易扩展及易维护的后端软件架构；最后把项目部署在Nginx服务器上，已有多个物业使用。\\
...
\item 本方案是针对Cocos2d-x现有开发问题而提出的新思路，借鉴了MVC开发模式和组件式编程风格。该方案改善了游戏开发中软件的复用性、扩展性及模块独立性（低耦合、职责单一、分层次开发）；最后，本人借鉴新思路\textbf{独立完成}了一款基于Coco2d-x引擎的仿消除类2D手游，证明了此方案的可行性。\\
...
\begin{rSection}{教育背景}
\textbf{电子科技大学}，航空航天学院，电子与通信工程专业，专业硕士。{\em 2015.09 至今}\\
\textbf{华北水利水电大学}，数学与信息科学学院，信息与计算科学专业，理学学士。{\em 2011.09 - 2015.06} \\ %\hfill {\em 2011-2015}
备注：喜欢接受新事物和挑战，本科期间参加中、美国大学生\textbf{数学建模}竞赛三次，曾获得河南赛区省一等奖，后因对建模的兴趣以2013年\textbf{国家二等奖}的成绩挤进前\textbf{6.5\%}，随后又取得2014 年美赛二等奖。此外，曾获国家励志奖学金（1次，专业前3名），校一等奖学金（2次，5\%），优秀学生（3次，8\%），优秀毕业论
文（3\%）等。
\end{rSection}
%----------------------------------------------------------------------------------------

%\begin{rSection}{所获荣誉和奖励}
%\begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
%本科阶段 & 国家励志奖学金，校一等奖学金（2次，5\%），优秀学生（3次，8\%），优秀毕业论
%文（3\%）\\
